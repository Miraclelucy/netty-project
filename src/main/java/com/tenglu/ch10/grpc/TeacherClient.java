 ...
 *  2 客户端发送一个请求，服务端返回流（a sequence of messages ）
 *  3 客户端发送流，服务端返回一个响应
 *  4 客户端发送流，服务端返回流
 * */

public class TeacherClient {
    private static final Logger logger = Logger.getLogger(TeacherClient.class.getName());
    ...
    TeacherClient(ManagedChannel channel) {
    ...
    public static void main(String[] args) throws Exception {
        TeacherClient client = new TeacherClient("localhost", 50051);
        try {
